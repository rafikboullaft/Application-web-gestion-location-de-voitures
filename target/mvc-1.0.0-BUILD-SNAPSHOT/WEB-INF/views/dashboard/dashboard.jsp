...
<body id="page-top">
      ...
      <div id="content">
       ...
       <%@ include file="/WEB-INF/views/menu_top/menu_top.jsp" %>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">les revenues du mois janvier est: ...<a target="_blank" href="https://www.chartjs.org/docs/latest/">official Chart.js documentation</a>.</p>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <hr>
                    ...
                    <div id="myAreaData2">[<c:forEach items="${dataofchartarea}" var="dataC">                   
					${dataC},</c:forEach>]
					</div>
					</div>
              </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-bar">
                    <canvas id="container-bar"></canvas>
                  </div>
                  <hr>
  ...
  mydata = document.getElementById("myAreaData2");
  /* for(var i=0; i<12 ;i++){
	  console.log("Hello world!" +i);
	  
	  mydata[i] = ${dataofchartarea[i]};
	  console.log("after ------------!" +${dataofchartarea[i]});
	  console.log("after ------------!" +"${dataofchartarea[i]}");
	  } */
