      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="${client}">Liste des clients</a>
            <a class="collapse-item" href="cards.html">Modifier clients</a>
          </div>
        </div>
      </li>
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"> Composants personnalisés:</h6>
            <a class="collapse-item" href="buttons.html">Liste des reservatins</a>
            <a class="collapse-item" href="cards.html">Effectuer</a>
          </div>
        </div>
      </li>
