          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Les revenus</h6>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">voitures réservée</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <hr>
                  les voitures disponible <code>VS</code> voitures réservée.
                </div>
              </div>
              <!-- assurance et visite -->
...
//Set new default font family and font color to mimic Bootstrap's default styling
  ...
  var piedata=['${v_reserver}','${v_nonreserver}']
  var ctx = document.getElementById("myPieChart");
  var myPieChart = new Chart(ctx, {
    type: 'doughnut',
    data: {
      labels: ["reservee", "disponible"],
      datasets: [{
        data: piedata,
        backgroundColor: ["#e76f51 ", '#4BCD6B'],
        hoverBackgroundColor: ['#e76f51', '#2a9d8f'],
  ...
  Chart.defaults.global.defaultFontFamily = 'Nunito', '-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif';
  Chart.defaults.global.defaultFontColor = '#858796';
  mydata = [<c:forEach items="${dataofchartarea}" var="dataC">                   
	${dataC},</c:forEach>];
  console.log([<c:forEach items="${dataofchartarea}" var="dataC">                   
	${dataC},</c:forEach>]);
        ...
        yAxes: [{
          ticks: {
            ...
            callback: function(value, index, values) {
              return 'MAD' + number_format(value);
            }
          },
          gridLines: {
      ...
      tooltips: {
        ...
        callbacks: {
          label: function(tooltipItem, chart) {
            ...
            return datasetLabel + ': MAD' + number_format(tooltipItem.yLabel);
          }
        }
      }
    }
